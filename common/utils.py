...
def init_arg_parser():
    ...
    arg_parser.add_argument('--mod', type=str, required=False, help='if the relation is used')
    ...
    #### Model configuration ####
    arg_parser.add_argument('--lstm', choices=['lstm','attention'], default='lstm', help='Type of LSTM used, currently only standard LSTM cell is supported')
    arg_parser.add_argument('--att_mode', choices=['rat','plus','dataflow','transformer'], default='rat', help='Type of attention to make the model looks at the api')
    ...
    arg_parser.add_argument('--num_heads', default=8, type=int, help='the number of heads for transformer')
    arg_parser.add_argument('--num_layers', default=8, type=int, help='the number of layers for the encoder')
