...
from datasets.hs import evaluator
...
def train(args):
    ...
    # print("oooooooooooooooooooooooooooooo",train_set)
    if args.dev_file:
    ...
    model.train()
    # print("model.train  is ：",args.parser)
    ...
    while True:
        ...
        for batch_examples in train_set.batch_iter(batch_size=args.batch_size, shuffle=True):
            ...
            # print("tgt_code", batch_examples[0].tgt_code)
            # print("tgt_ast", batch_examples[0].tgt_ast)
            # print("tgt_actions", batch_examples[0].tgt_actions)
        ...
        if args.dev_file:
            if epoch % args.valid_every_epoch == 0:
                ...
                print("the metric _____", evaluator.default_metric)
...
def train_rerank_feature(args):
    ...
    while True:
        ...
        for batch_examples in train_set.batch_iter(batch_size=args.batch_size, shuffle=True):
            ...
            print("in the exp, starting to train")
            if train_paraphrase_model:
